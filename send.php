...
$log.="<li>Campo non valido \"Nome\" (3-15 personaggi)!</li>"; $error="yes"; }
...
if($posEmail == '')
                {
	$log .= "<li>Per favore inserisci la tua email!</li>";
	$error = "yes";
	...
	$log .= "<li>Hai inserito un'e-mail errata. Si prega di correggerlo!</li>";
	$error = "yes";
                }
...
if (empty($posText))
{
	$log .= "<li>Devi specificare il testo del messaggio!</li>";
	$error = "yes";
}
...
{
	$log .= "<li>Il testo è troppo lungo, 1000 caratteri sono a tua disposizione!</li>";
	$error = "yes";
}
...
foreach($mas as $index => $val)
{
  if (strlen($val)>60)
  {
	$log .= "<li>Parole troppo lunghe (più di 60 caratteri) nel testo della voce!</li>";
	$error = "yes";
	break;
  }
}
...
$to = "info@fornazza.it";//Ваш e-mail адрес
$mes = "$posName ti ho inviato un messaggio dal modulo di feedback fornazza.it: \n\n$posText";

$from = $posEmail;
$sub = '=?utf-8?B?'.base64_encode('Nuovo messaggio dal tuo sito').'?=';
$headers = 'From: '.$from.'
';
